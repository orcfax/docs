...
messages and knowledge from the gods to the mortals. Blockchain oracles such
as [Orcfax][oracle-1],
[Chainlink][oracle-2], [Charli3][oracle-3], etc. are the technical component
in blockchain architectures which deliver data about the real world on-chain
for consumption by smart contracts. These are not to be confused by the
database software manufacturer named "Oracle Corporation".
