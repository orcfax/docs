...
import fileOne from '!!raw-loader!/schema/cer/cex/message.json';

<!-- just as a demo, we probably want above -->
import fileTwo from '!!raw-loader!./fact-statement.json';
...
<a target="_blank" href="./fact-statement.json" download="fact-statement.json">Download doesn't work</a>
