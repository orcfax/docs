...
Orcfax is an [oracle service](https://docs.orcfax.io/#what-is-an-oracle) that publishes facts about real world events to the [Cardano](https://cardano.org/) blockchain.
