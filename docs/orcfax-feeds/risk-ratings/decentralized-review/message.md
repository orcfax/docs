...
import Message from '!!raw-loader!/schema/risk-rating/decentralized-review/message.json';
...
<a target="_blank" href="/schema/risk-rating/decentralized-review/Message.json" download="Message.json">Download</a>
