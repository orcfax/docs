...
import factStatementDatum from "/schema/cer/cex/fact-statement-datum.json";
...
<CodeBlock language="jsx">{JSON.stringify(factStatementDatum, null, 2)}</CodeBlock>

<a
    target="_blank"
    href="/schema/cer/cex/fact-statement-datum.json"
