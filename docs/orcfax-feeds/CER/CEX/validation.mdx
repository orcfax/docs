...
import Validation from "/schema/cer/cex/validation.json";
...
<CodeBlock language="jsx">{JSON.stringify(Validation, null, 2)}</CodeBlock>

<a target="_blank" href="/schema/cer/cex/validation.json" download="validation.json">
    Download
</a>
